  ...
  const recipes = [
    {
      ...
      description: "This is a delicious Chicken Alfredo recipe that is perfect for a cozy dinner. It combines tender chicken, creamy Alfredo sauce, and perfectly cooked pasta for a meal that everyone will love.",
      steps: [
        {
